...
Requires:   python2-django-appconf
Requires:   python2-lesscpy
...
Requires:   python2-pymongo >= 3.0.2
Requires:   python2-django-pyscss >= 2.0.2
Requires:   python2-semantic_version
...
Requires:   python2-XStatic-Hogan
Requires:   python2-XStatic-JQuery-Migrate
Requires:   python2-XStatic-JQuery-TableSorter
Requires:   python2-XStatic-JQuery-quicksearch
Requires:   python2-XStatic-JSEncrypt
Requires:   python2-XStatic-Jasmine
Requires:   python2-XStatic-Rickshaw
Requires:   python2-XStatic-Spin
Requires:   python2-XStatic-jquery-ui
Requires:   python2-XStatic-Bootstrap-Datepicker
Requires:   python2-XStatic-Bootstrap-SCSS >= 3.3.7.1
Requires:   python2-XStatic-termjs
Requires:   python2-XStatic-smart-table
Requires:   python2-XStatic-Angular-lrdragndrop
Requires:   python2-XStatic-Angular-Gettext
Requires:   python2-XStatic-Angular-FileUpload
Requires:   python2-XStatic-Magic-Search
...
BuildRequires: python2-django-appconf
...
BuildRequires: python2-XStatic-Hogan
BuildRequires: python2-XStatic-JQuery-Migrate
BuildRequires: python2-XStatic-JQuery-TableSorter
BuildRequires: python2-XStatic-JQuery-quicksearch
BuildRequires: python2-XStatic-JSEncrypt
BuildRequires: python2-XStatic-Jasmine
BuildRequires: python2-XStatic-Rickshaw
BuildRequires: python2-XStatic-Spin
BuildRequires: python2-XStatic-jquery-ui
BuildRequires: python2-XStatic-Bootstrap-Datepicker
...
BuildRequires: python2-XStatic-Angular-lrdragndrop
BuildRequires: python2-XStatic-Angular-FileUpload
BuildRequires: python2-XStatic-Magic-Search
