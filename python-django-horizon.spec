...
%global excluded_reqs enmerkar XStatic XStatic-Angular XStatic-JQuery-Migrate XStatic-jquery-ui
...
# requirements-override-centos C9S is providing pytest-5.4.1 while package requires >= 6.0
