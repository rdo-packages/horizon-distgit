...
%changelog
* Wed Mar 19 2025 RDO <dev@lists.rdoproject.org> 1:25.3.0-1
- Update to 25.3.0

* Tue Mar 18 2025 RDO <dev@lists.rdoproject.org> 1:25.2.0-1
- Update to 25.2.0


# REMOVEME: error caused by commit https://opendev.org/openstack/horizon/commit/eee37cd646016082df785917814392dc5604dfa9
