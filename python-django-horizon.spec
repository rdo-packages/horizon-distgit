...
sed -i 's/^XStatic>=/\L&/' requirements.txt
sed -i 's/^XStatic-Angular>=/\L&/' requirements.txt
sed -i 's/^XStatic-JQuery-Migrate>=/\L&/' requirements.txt
sed -i 's/^XStatic-jquery-ui>=/\L&/' requirements.txt
